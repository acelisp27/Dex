...
//  Dex
//
//  Created by Andres Celis on 14/08/25.
//
//
...
class Pokemon: Decodable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        while !typesContainer.isAtEnd {
            ...
            typesContainer.nestedContainer(keyedBy:
                                            CodingKeys.TypeDictionaryKeys.self)
            
            let typeContainer = try typesDictionaryContainer.nestedContainer(keyedBy:
                                    CodingKeys.TypeDictionaryKeys.TypeKeys.self,forKey: .type)
        ...
        while !statsContainer.isAtEnd {
            let statsDictionaryContainer = try
            statsContainer.nestedContainer(keyedBy:
                                            CodingKeys.StatDictionaryKeys.self)
